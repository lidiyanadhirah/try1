...
public class ReviewRF extends AppCompatActivity {
    ...
    List<CommentRF> commentRFList;
    ListView listViewComments;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.rf_layout);

        databaseComments = FirebaseDatabase.getInstance().getReference("commentRFs");
    ...
    private void addComment() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            //store
            CommentRF comments = new CommentRF(id, name, comment);
        ...
        databaseComments.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    //getting artist
                    CommentRF commentRF = postSnapshot.getValue(CommentRF.class);
                    //adding artist to the list
                    commentRFList.add(commentRF);
                }

                //creating adapter
                CommentListRF commentAdapter = new CommentListRF(ReviewRF.this, commentRFList);
