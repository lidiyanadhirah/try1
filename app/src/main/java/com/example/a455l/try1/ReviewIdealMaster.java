...
public class ReviewIdealMaster extends AppCompatActivity {
    ...
    private void addComment() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            Toast.makeText(this, "CommentTP added", Toast.LENGTH_LONG).show();

        } else {
            //if the name is empty
            //if the value is not given displaying a toast
            Toast.makeText(this, "Please enter your Name & CommentTP", Toast.LENGTH_LONG).show();
        }
    }
    ...
    protected void onStart() {
        ...
        databaseComments.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                CommentListTP commentAdapter = new CommentListTP(ReviewIdealMaster.this, commentTPList);
