...
public class ReviewMY extends AppCompatActivity {
    ...
    private void addComment() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            //store
            CommentMY comments = new CommentMY(id, name, comment);
        ...
        databaseComments.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    //getting artist
                    CommentMY commentMY = postSnapshot.getValue(CommentMY.class);
                    //adding artist to the list
                    commentMYList.add(commentMY);
                }

                //creating adapter
                CommentListMY commentAdapter = new CommentListMY(ReviewMY.this, commentMYList);
